...
function onCreate()
    ...
    setPropertyFromClass('substates.GameOverSubstate', 'deathSoundName', 'fnf_loss_sfx_hasshaku1');
    setPropertyFromClass('substates.GameOverSubstate', 'loopSoundName', 'gameOver_hasshaku1');
    setPropertyFromClass('substates.GameOverSubstate', 'endSoundName', 'gameOverEnd_hasshaku1');
