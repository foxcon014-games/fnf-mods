...
function onStartCountdown()
	if isStoryMode and not seenCutscene then
		if playVideo then --Video cutscene plays first
			startVideo('cutscene3'); --Play video file from "videos/" folder
			playVideo = false;
...
function onStepHit()
    ...
    if curStep % 4 == 1 and intense_mode == true then
...
-- Camera Movement Script By [credit here] --
