...
idle_xml_name = 'Dad idle dance WeakenEmpty'
right_xml_name = 'Dad Sing NOTE RIGHT WeakenEmpty'
down_xml_name = 'Dad Sing Note DOWN WeakenEmpty'
up_xml_name = 'Dad Sing NOTE UP WeakenEmpty'
left_xml_name = 'Dad Sing Note LEFT WeakenEmpty'
...
name_of_character_xml = 'dad-3'
name_of_character = 'dad-3'
