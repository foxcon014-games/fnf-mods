...
idle_xml_name = 'Dad idle dance Weaken'
right_xml_name = 'Dad Sing NOTE RIGHT Weaken'
down_xml_name = 'Dad Sing Note DOWN Weaken'
up_xml_name = 'Dad Sing NOTE UP Weaken'
left_xml_name = 'Dad Sing Note LEFT Weaken'
...
name_of_character_xml = 'dad-3-mad'
name_of_character = 'dad-4'
