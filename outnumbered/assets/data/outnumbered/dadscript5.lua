...
idle_xml_name = 'Dad idle dance Corrupt'
right_xml_name = 'Dad Sing NOTE RIGHT Corrupt'
down_xml_name = 'Dad Sing Note DOWN Corrupt'
up_xml_name = 'Dad Sing NOTE UP Corrupt'
left_xml_name = 'Dad Sing Note LEFT Corrupt'
...
name_of_character_xml = 'dad-dead'
name_of_character = 'dad-5'
