...
idle_xml_name = 'Dad idle dance Pissed'
right_xml_name = 'Dad Sing NOTE RIGHT Pissed'
down_xml_name = 'Dad Sing Note DOWN Pissed'
up_xml_name = 'Dad Sing NOTE UP Pissed'
left_xml_name = 'Dad Sing Note LEFT Pissed'
...
name_of_character_xml = 'dad-2-mad'
name_of_character = 'dad-2-mad'
